...
const REASONS = [
  {
    name: "Your current site already passes on speed, booking, and accessibility",
    body: "You do not need this. A visual refresh alone is a smaller, separate project.",
  },
  {
    name: "You want the cheapest possible build",
    body: "There are template sites for a few hundred dollars. They will not be built to WCAG 2.1 AA or pass Core Web Vitals reliably.",
  },
  {
    name: "You need it live next week",
    body: "A real audit, rebuild, and accessibility pass takes real weeks, not days.",
  },
  {
    name: "You want us to guarantee a specific patient-volume increase from the redesign alone",
    body: "A website removes friction. It does not manufacture demand — that is what the AI visibility and SEO work on this site is for.",
  },
] as const;

export function MwdNotFor() {
  return (
