      ...
      <Container>
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          <p className="mt-3 max-w-2xl text-white/70">
            It also tells you whether a slow or hard-to-book website is actually costing you patients, or whether the
            gap is somewhere else entirely.
          </p>
          <div className="mt-10">
            <PrimaryCta href="/tools/ai-visibility-checker/" dataCta="mwd-closing">
