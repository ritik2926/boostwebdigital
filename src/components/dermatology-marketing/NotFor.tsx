...
const REASONS = [
  {
    ...
    body: "A thin review profile undercuts both sides of this work before it starts. Fix reputation first, on either the medical or cosmetic side — ideally both.",
  },
  {
    name: "Need results in 30 days",
    body: "AI citations tend to move fast. Patient volume moves slower. Neither one moves inside a month.",
  },
  {
    name: "Won't change the website",
    body: "Rebuilding thin medical and cosmetic pages is most of this work. Take the pages off the table and there isn't much left to do.",
  },
  {
    name: "Looking for the cheapest option",
    body: "Plenty of agencies charge less to run one generic scan. What they skip is exactly the medical/cosmetic split this page is built around.",
  },
  {
    name: "Medical-only, no cosmetic line at all",
    body: "The med-spa-competition half of this page doesn't apply to you. A plainer medical-only approach, using only the medical query set, probably serves you better. We'll tell you that directly on the first call, not after you've signed something.",
  },
] as const;

export function DermatologyNotFor() {
  return (
