...
export function HairRestorationGoogleAdsClosingCta() {
  return (
      ...
      <Container>
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-white/70">
            Free report on your organic AI visibility, whether or not you run ads with us. Nobody has to call you
            first.
          </p>
          <div className="mt-10">
            <PrimaryCta href="/tools/ai-visibility-checker/" dataCta="hair-restoration-google-ads-closing">
              Get My Free Report
            </PrimaryCta>
          </div>
          <p className="mt-8 max-w-xl text-sm text-white/50">
            See the full engagement on{" "}
            <Link href="/hair-restoration-marketing/" className="text-white/70 underline-offset-4 hover:text-accent hover:underline">
              hair restoration marketing
            </Link>
            , or the organic side on{" "}
