...
export function HairRestorationSeoClosingCta() {
  return (
      ...
      <Container>
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-white/70">
            Free report against the exact query stages above. Nobody has to call you first.
          </p>
          <div className="mt-10">
            <PrimaryCta href="/tools/ai-visibility-checker/" dataCta="hair-restoration-seo-closing">
              Get My Free Report
            </PrimaryCta>
          </div>
          <p className="mt-8 max-w-xl text-sm text-white/50">
            See the full engagement, including our real client result, on{" "}
