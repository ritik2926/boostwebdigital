...
export function HairRestorationWebsiteDesignClosingCta() {
  return (
      ...
      <Container>
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          <p className="mt-6 max-w-2xl text-white/70">
            Free report on your organic AI visibility, whether or not you rebuild with us. Nobody has to call you
            first.
          </p>
          <div className="mt-10">
            <PrimaryCta href="/tools/ai-visibility-checker/" dataCta="hair-restoration-website-design-closing">
              Get My Free Report
            </PrimaryCta>
          </div>
