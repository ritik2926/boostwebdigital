  ...
  <main class="hb-main">
    ...
    <section class="hb-chapter hb-wide" id="uiux">
      ...
      <div class="hb-learn-grid" style="margin-top:28px;">
        ...
        <div class="hb-learn-card"><dt>One primary action per screen</dt><dd>A confident, accent-colored button for the one thing you most want someone to do; a quieter neutral button for everything else — never two loud buttons competing.</dd><div class="hb-real"><b>On your site:</b> the <code class="mono">.btn-primary</code> (accent-outlined, fills solid on hover) and <code class="mono">.ghost-cta</code> (neutral glass chip) button styles exist specifically to enforce this rule sitewide — exactly two variants, no exceptions.</div></div>
