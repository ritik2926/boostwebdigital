...
const DESCRIPTION =
  "Two live tools: check whether an AI answer engine names your practice, and check a draft review reply for HIPAA exposure before you post it. Free, no signup.";
 ...
 *
 * Two entries live as of the Review Reply HIPAA Checker's ship date:
 * /tools/ai-visibility-checker/ and /tools/review-reply-hipaa-checker/.
 * /research/ and /compare/ are still NOT built and are not mentioned here at
 * all — both have zero children.
 */
      ...
      <main>
          ...
          <Container>
            <div className="max-w-2xl">
              ...
              <p className="mt-4 max-w-[58ch] text-white/70">
                Two are live right now. One checks whether a live AI answer engine actually names your practice.
                The other checks a draft reply to a patient review for HIPAA exposure, entirely in your browser.
              </p>
              <p className="mt-4 max-w-[58ch] text-white/70">
        ...
        <section className={cn("relative", SECTION_PADDING.default)}>
          <Container>
            ...
            <h2 className={cn(H2, STACK.kickerToHeading, "max-w-2xl")}>Two Tools, and What Each Actually Does</h2>
            <p className={cn(STACK.headingToSub, "max-w-2xl text-white/70")}>
              ...
              first checker below tells you whether yours is one of the practices that gets named.
            </p>
            ...
            <div className={cn(STACK.subToContent, "rounded-2xl border border-white/8 bg-white/[0.02] p-8")}>
              <h3 className="font-display text-xl font-semibold text-white">Review Reply HIPAA Checker</h3>
              <p className="mt-3 max-w-2xl text-white/70">
                Paste a draft reply to a patient review. We flag the phrases that could create HIPAA exposure —
                confirming someone is a patient, naming a condition or a date, mentioning billing — and show a
                safer template underneath.
              </p>
              <ul className="mt-4 flex max-w-2xl flex-col gap-2 text-sm text-white/60">
                <li>Your text never leaves your browser — nothing is sent to us, stored, or logged.</li>
                <li>Six pattern checks, each with a plain reason.</li>
                <li>A general safe-reply template, shown either way.</li>
                <li>A pattern check, not a compliance guarantee — never a &ldquo;safe to post&rdquo; score.</li>
              </ul>
              <div className="mt-6">
                <PrimaryCta href="/tools/review-reply-hipaa-checker/" dataCta="tools-index-hipaa-checker">
                  Check My Reply
                </PrimaryCta>
              </div>
        ...
        <section className={cn("relative", SECTION_PADDING.compact)}>
          <Container>
            <p className="max-w-2xl text-white/70">
              These are the only tools live today. Nothing else on this page is coming soon or in progress. We will
              add to this page the day a third tool is genuinely live, not before.
            </p>
